...
ReactDOM.render(
  <TradingCard name="Yichi" skill="eating carrots" imgUrl="/static/img/seedpy.jpeg" />,
  document.querySelector('#yichi')
);

ReactDOM.render(
  <TradingCard name="Scout" skill="eating cabbage" imgUrl="/static/img/shortstack-overflow.jpeg" />,
